package com.myaccountbook.global.exception;

import com.myaccountbook.global.response.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleAuthentication(AuthenticationException e) {
        return ResponseEntity
                ...
                .body(ErrorResponse.of(HttpStatus.UNAUTHORIZED.value(), "인증이 필요합니다."));
    }
